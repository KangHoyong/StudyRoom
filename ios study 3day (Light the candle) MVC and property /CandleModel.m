...
- (instancetype) init{
    ...
    if(self){
        // 구현부분
        _ImageCandlOn = [UIImage imageNamed:@"image/candleon.png"];
        _ImageCandlOff = [UIImage imageNamed:@"image/candleoff.png"];
...
// (선택영역 주석처리) 주석처리할 영역을 선택하고 command + /
//@synthesize ImageCandlOn;
