...
- (IBAction)touchSwitch:(id)sender{
    ...
    */
    ...
    if(nowStatus == TRUE)
    {
        //[viewImage setImage:[UIImage imageNamed:@"image/candleon.png"]];
        //[labelStatus setText:@"촛불이 켜졌습니다 !!! "];
        [viewImage setImage:[modelCandle imageCandleOn]];
    }
    else
    {
        //[viewImage setImage:[UIImage imageNamed:@"image/candleoff.png"]];
        //[labelStatus setText:@"촛불이 꺼졌씁니다 !!!!"];
        [viewImage setImage:[modelCandle imageCandleOff]];
    }
    [labelStatus setText:[modelCandle stringNowStatus]];
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    // 팩토리 메소드 없음 그러므로 일반적으로 메모리 할당 초기화 구문을 수행할수 있도록 인스턴스 멤버변수 선언 -> ModelCandle save
